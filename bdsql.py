...
engine = create_engine(DATABASE_URL, pool_pre_ping=True, pool_recycle=300,pool_size =5,max_overflow=10,connect_args={"options":"-c search_path=public","sslmode":"require"})
